...
var OpenSeaPort = /** @class */ (function () {
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        console.error('_getBuyFeeParameters');
    ...
    OpenSeaPort.prototype._validateMatch = function (_a, retries) {
        var _b;
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _c = _a.shouldValidateBuy, shouldValidateBuy = _c === void 0 ? false : _c, _d = _a.shouldValidateSell, shouldValidateSell = _d === void 0 ? false : _d;
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 7:
                        error_11 = _e.sent();
                        if (retries <= 0) {
                            throw new Error("Error matching this listing: " + ((_b = error_11) === null || _b === void 0 ? void 0 : _b.message) + ". Please contact the maker or try again later!");
                        }
                        return [4 /*yield*/, (0, utils_1.delay)(500)];
                    case 8:
                        _e.sent();
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        var _b;
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _c = _a.metadata, metadata = _c === void 0 ? constants_1.NULL_BLOCK_HASH : _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 10:
                        ...
                        throw new Error("Oops, the Ethereum network rejected this transaction :( The OpenSea devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"" + ((_b = error_13) === null || _b === void 0 ? void 0 : _b.message.substr(0, debugging_1.MAX_ERROR_LENGTH)) + "...\"");
                    case 11:
