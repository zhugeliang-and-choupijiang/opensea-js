...
var OpenSeaAPI = /** @class */ (function () {
    ...
    OpenSeaAPI.prototype.getAsset = function (_a, retries) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.get(constants_1.API_PATH + "/asset/" + tokenAddress + "/" + (tokenId || 0) + "/")];
                    case 1:
                        json = _b.sent();
                        return [2 /*return*/, (0, utils_1.assetFromJSON)(json)];
                }
            });
        });
    };
    ...
    OpenSeaAPI.prototype.getPaymentTokens = function (query, page, retries) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.get(constants_1.API_PATH + "/tokens/", __assign(__assign({}, query), { limit: this.pageSize, offset: (page - 1) * this.pageSize }))];
                    case 1:
                        json = _a.sent();
                        return [2 /*return*/, {
     ...
     */
    OpenSeaAPI.prototype.get = function (apiPath, query, retries) {
        if (query === void 0) { query = {}; }
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var qs, url, response, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.get(apiPath, query, retries - 1)];
